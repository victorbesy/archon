...
VL_ATTR_COLD void Vcs_common_shunt_dpi_pkg___ctor_var_reset(Vcs_common_shunt_dpi_pkg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcs_common__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vcs_common_shunt_dpi_pkg___ctor_var_reset\n"); );
